...
from fipomdp.pomcp_NYC_unshielded import OnlineStrategy
...
def log_experiment_with_seed(cpomdp, env, i, log_file_name, solver, targets):
    handler = logging.FileHandler(f"./logs_NYC_unshielded/{log_file_name}{i}.log", 'w')
...
def main():
    log_file_name = "NYCExperiments_unshielded"  # Change for your needs
