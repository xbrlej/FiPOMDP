...
from fipomdp.pomcp_tiger import OnlineStrategy
...
def log_experiment_with_seed(cpomdp, env, i, log_file_name, solver, targets):
    handler = logging.FileHandler(f"./logs_tiger_fuzzy_unshielded/{log_file_name}{i}.log", 'w')
...
def main():
    log_file_name = "TigerExperimentsFuzzy_ushielded"  # Change for your needs
