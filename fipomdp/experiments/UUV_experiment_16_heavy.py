...
from fipomdp.pomcp_16_sparse import OnlineStrategy
...
def log_experiment_with_seed(cpomdp, env, i, log_file_name, solver, targets):
    handler = logging.FileHandler(f"./logs_16_heavy/{log_file_name}{i}.log", 'w')
...
def main():
    log_file_name = "UUVExperimentsFromPythonFile_16_heavy"  # Change for your needs
    ...
    with open("cpomdp_16", "wb") as cpomdp_file:
