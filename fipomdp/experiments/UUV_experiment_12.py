...
def log_experiment_with_seed(cpomdp, env, i, log_file_name, solver, targets):
    handler = logging.FileHandler(f"./logs/logs_12/{log_file_name}{i}.log", 'w')
...
def main():
    log_file_name = "UUVExperimentsFromPythonFile_12"  # Change for your needs
    ...
    with open("pickled/cpomdp_12", "wb") as cpomdp_file:
