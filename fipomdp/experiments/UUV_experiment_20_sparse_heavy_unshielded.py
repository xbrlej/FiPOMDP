...
from fipomdp.pomcp_20_sparse_unshielded import OnlineStrategy
...
def log_experiment_with_seed(cpomdp, env, i, log_file_name, solver, targets):
    handler = logging.FileHandler(f"./logs_20_sparse_heavy_unshielded/{log_file_name}{i}.log", 'w')
...
def main():
    log_file_name = "UUVExperimentsFromPythonFile_20_sparse_heavy_unshielded"  # Change for your needs
    ...
    with open("cpomdp_20_un", "wb") as cpomdp_file:
